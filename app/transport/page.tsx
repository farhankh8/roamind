...
export default function Transport() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: BG, color: '#fff', fontFamily: "'Outfit',sans-serif", overflow: 'hidden' }}>
      ...
      {/* SIDEBAR */}
      <div style={{ width: sidebarOpen ? 256 : 64, minWidth: sidebarOpen ? 256 : 64, background: '#05090f', borderRight: '1px solid rgba(0,212,255,0.07)', display: 'flex', flexDirection: 'column', transition: 'all 0.3s ease', overflow: 'hidden', flexShrink: 0, zIndex: 50 }}>
        <div style={{ padding: '20px 16px', display: 'flex', alignItems: 'center', gap: 10, borderBottom: '1px solid rgba(0,212,255,0.07)', flexShrink: 0 }}>
          <div style={{ width: 36, height: 36, borderRadius: 10, background: 'linear-gradient(135deg,rgba(0,212,255,0.2),rgba(255,183,77,0.15))', border: '1px solid rgba(0,212,255,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, flexShrink: 0 }}>🌍</div>
          {sidebarOpen && <span style={{ fontFamily: "'Playfair Display',serif", fontSize: 18, fontWeight: 900, background: 'linear-gradient(130deg,#fff 30%,#00d4ff 70%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', whiteSpace: 'nowrap' }}>Roamind</span>}
        </div>
          ...
          {navSections.map((section, si) => (
            <div key={si} style={{ marginBottom: 8 }}>
              ...
              {section.items.map(item => (
                <button key={item.path} onClick={() => nav(item.path)} style={{ width: '100%', display: 'flex', alignItems: 'center', gap: 10, padding: sidebarOpen ? '9px 10px' : '9px 0', justifyContent: sidebarOpen ? 'flex-start' : 'center', background: activePath === item.path ? 'rgba(0,212,255,0.1)' : 'transparent', border: activePath === item.path ? '1px solid rgba(0,212,255,0.18)' : '1px solid transparent', borderRadius: 9, cursor: 'pointer', marginBottom: 2, transition: 'all 0.18s' }}
        ...
        <div style={{ padding: '10px', borderTop: '1px solid rgba(0,212,255,0.07)', flexShrink: 0 }}>
          {sidebarOpen && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '9px 10px', background: 'rgba(255,255,255,0.03)', borderRadius: 10, marginBottom: 8, border: '1px solid rgba(255,255,255,0.05)' }}>
              <div style={{ width: 30, height: 30, borderRadius: '50%', background: 'linear-gradient(135deg,#00d4ff,#ffb74d)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 700, color: '#000814', flexShrink: 0 }}>{avatar}</div>
